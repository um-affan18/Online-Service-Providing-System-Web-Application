...
<php lang="en">
    ...
    <head>
        ...
        <title>AC Cooling Problem- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/ac-coolingproblem-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-5 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">AC Cooling Problem</h1>
                            ...
                            <div class="mt-4">
                                ...
                                <form method="GET" action="service-booking.php">
                                    <input type="hidden" name="varservice" value="AC Cooling Problem">
                                    <input type="hidden" name="varserviceamount" value="1300">
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of AC Cooling Problem</h3>
                        </div>
                    </header>
