...
<php lang="en">
    ...
    <head>
        ...
        <title>AC Jet Wash Service- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/ac-jetwash-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-7 col-md-7">
                            <h1 data-aos="fade-right" data-aos-duration="1500">AC Jet Wash Service</h1>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="AC Jet Wash">
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of AC Jet Wash Service</h3>
                        </div>
                    </header>
