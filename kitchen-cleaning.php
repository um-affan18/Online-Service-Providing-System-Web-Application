...
<php lang="en">
    ...
    <head>
        ...
        <title>Kitchen Cleaning-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/kitchen-cleaning-banner-1.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-5 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">Kitchen Cleaning</h1>
                            ...
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Trusted and Experienced Cleaner<i class="fa-solid fa-badge-check"></i></p>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Best Quality Cleaning Accessories<i class="fa-solid fa-badge-check"></i></p>
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Kitchen Cleaning">
                                        <input type="hidden" name="varserviceamount" value="900">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 900 TK</i></butoon>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of Kitchen Cleaning</h3>
                        </div>
                    </header>
