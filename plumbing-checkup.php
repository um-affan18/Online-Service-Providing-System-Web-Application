...
<head>
    ...
    <title>Plumbing Check UP-- TX Service Hand</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="home">
        <header>
            <style>
                .top-banner {
                    background: url(assets/images/servicepic/plumbing-checkp-banner.jpg);
            ...
            <div class="container">
                <div class="row banner">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <h1 data-aos="fade-right" data-aos-duration="1500">Plumbing Check UP</h1>
                        ...
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                ...
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Plumbing Check UP">
            ...
            <div class="row">
                <header class="section-header">
                    <div class="col-12 section-intro">
                        <h3>Overview Of Plumbing Check UP</h3>
                    </div>
                </header>
