...
<php lang="en">
    ...
    <head>
        ...
        <title>Computer Service-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/computer-service-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">Compter Service</h1>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Best Service at an Affordable Price<i class="fa-solid fa-badge-check"></i></p>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>On time work completion<i class="fa-solid fa-badge-check"></i></p>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Professional Technician<i class="fa-solid fa-badge-check"></i></p>

                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Computer Service">
                                        <input type="hidden" name="varserviceamount" value="500">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 500 TK</i></butoon>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of Computer Service</h3>
                        </div>
                    </header>
                    <div class="col-lg-12 pb-xl-3 px-xl-5">
                        <h4 class="pb-2">What's included?</h4>
                        <ul>
                            <li>
                                <p>Solution to any Hardware (e.g. Motherboard, Hard Drive, Power Supply Unit etc.)</p>
                            </li>
                            <li>
                                <p>Solution to any Software (e.g. OS Installation, Virus etc.)</p>
                            </li>
                    ...
                    <div class="col-lg-12 pb-xl-3 px-xl-5">
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Transpotation Cost (if applicable)</p>
                            </li>
