...
<php lang="en">
  ...
  <head>
    ...
    <title>Cleaning Service Category-- TX Service Hand</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 section-intro">
              <h1 class="text-white" data-aos="zoom-in" data-aos-duration="1500">Cleaning Service List
              </h1>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row mt-3 mx-0">
          ...
          <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
            <div class="card service-card">
              <div class="service-img">
                <img src="assets/images//servicepic/common-space-cleaning.jpg" class="img-fluid">
              </div>
              <a class="card-btn" href="common-space-cleaning.php">
                <div class="card-footer">
                  <h3>Common Space Cleaning</h3>
                  <span>Start From 800Tk</span>
                </div>
              </a>
            </div>
          ...
          <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
            <div class="card service-card">
              <div class="service-img">
                <img src="assets/images//servicepic/floor-cleaning.jpg" class="img-fluid">
              </div>
              <a class="card-btn" href="floor-cleaning.php">
                <div class="card-footer">
          ...
          <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
            <div class="card service-card">
              <div class="service-img">
                <img src="assets/images//servicepic/bathroom-cleaning.jpg" class="img-fluid">
              </div>
              <a class="card-btn" href="bathroom-cleaning.php">
                <div class="card-footer">
