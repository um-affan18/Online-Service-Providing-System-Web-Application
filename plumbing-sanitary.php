...
<head>
    ...
    <title>Plumbing & Sanitary Service-- TX Service Hand</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 section-intro">
                        <h1 class="text-white" data-aos="zoom-in" data-aos-duration="1500">Plumbing & Sanitary Service
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-3 mx-0">
                ...
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        <div class="service-img">
                            <img src="assets/images//servicepic/water-meter-servicing.jpg" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        <div class="service-img">
                            <img src="assets/images//servicepic/plumbing-check-up.jpg" class="img-fluid">
                        </div>
                        <a class="card-btn" href="plumbing-checkup.php">
                            <div class="card-footer">
                                <h3>Plumbing Check Up</h3>
                                <span>Start From 500Tk</span>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        <div class="service-img">
                            <img src="assets/images//servicepic/Water-tap-servicing.jpg" class="img-fluid">
                        </div>
