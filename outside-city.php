...
<php lang="en">
    ...
    <head>
        ...
        <title>Outside City Car Rental-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/outsidecity-car-rental-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">Outside City Car Rental Service</h1>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Easy & Fast - Book a Car in 120 minutes<i class="fa-solid fa-badge-check"></i></p>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Best Price with Quality Service<i class="fa-solid fa-badge-check"></i></p>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Choose from a Wide Variety of Cars<i class="fa-solid fa-badge-check"></i></p>

                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Outside City Car Rental">
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of Outside City Car Rental Service</h3>
                        </div>
                    </header>
