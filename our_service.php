...
<head>
    ...
    <title>Our Services-- TX Service Hand</title>
                            ...
                            <div class="row">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="cleaning_service.php">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="furniture-cleaning.php">
                                            <div class="card-footer">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="kitchen-cleaning.php">
                                            <div class="card-footer">
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="office-shifting.php">
                                            <div class="card-footer">
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="refrigator-repair.php">
                                            <p class="view-all text-end">View All<i
                                                    class="fa-solid fa-right-to-bracket px-1"></i>
                                            </p>
                                        </a></div>
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="plumbing-sanitary.php">
                                            <p class="view-all text-end">View All<i
                                                    class="fa-solid fa-right-to-bracket px-1"></i>
                                            </p>
                                        </a></div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="water-meter-servicing.php">
                                            <div class="card-footer">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="sink-repair.php">
                                            <div class="card-footer">
                                                <h3>Sink Repair</h3>
                                                <span>Start From 500Tk</span>
                                            </div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="water-tap-servicing.php">
                                            <div class="card-footer">
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="paint-service.php">
                                            <p class="view-all text-end">View All<i
                                                    class="fa-solid fa-right-to-bracket px-1"></i>
                                            </p>
                                        </a></div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="interior-paint.php">
                                            <div class="card-footer">
                                                <h3>Interior Paint</h3>
                                                <span>Start From 7200Tk</span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="furniture-paint.php">
                                            <div class="card-footer">
                                                <h3>Wood & Furniture Paint</h3>
                                                <span>Start From 3200Tk</span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="exterior-paint.php">
                                            <div class="card-footer">
                                                <h3>Exterior Paint</h3>
                                                <span>Start From 12500Tk</span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="inside-city.php">
                                            <div class="card-footer">
                                                <h3>Inside City</h3>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="outside-city.php">
                                            <div class="card-footer">
                                                <h3>Outside City</h3>
                                                <span>Start From 900Tk</span>
                                            </div>
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="car-care.php">
                                                <p class="view-all text-end">View All<i
                                                        class="fa-solid fa-right-to-bracket px-1"></i>
                                                </p>
                                            </a></div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="car-servicing.php">
                                            <div class="card-footer">
                                                <h3>Car Servicing</h3>
                                                <span>Start From 2000Tk</span>
                                            </div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="car-wash.php">
                                            <div class="card-footer">
                                                <h3>Car Wash</h3>
                                                <span>Start From 500Tk</span>
                                            </div>
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="ac-repair.php">
                                            <p class="view-all text-end">View All<i
                                                    class="fa-solid fa-right-to-bracket px-1"></i>
                                            </p>
                                        </a></div>
                               ...
                               <div class="col-lg-4 col-sm-6 mb-5">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="ac-jet-wash.php">
                                            <div class="card-footer">
                                                <h3>AC Jet Wash</h3>
                                                <span>Start From 1200Tk</span>
                                            </div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="ac-installation.php">
                                            <div class="card-footer">
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="electrical-service.php">
                                            <p class="view-all text-end">View All<i
                                                    class="fa-solid fa-right-to-bracket px-1"></i>
                                            </p>
                                        </a></div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="computer-service.php">
                                            <div class="card-footer">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="cctv-service.php">
                                            <div class="card-footer">
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="tv-service.php">
                                            <div class="card-footer">
                            ...
                            <div class="row" data-aos="fade-up" data-aos-duration="1500">
                                <header class="section-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="col-4"><a href="trip-travels.php">
                                            <p class="view-all text-end">View All<i
                                                    class="fa-solid fa-right-to-bracket px-1"></i>
                                            </p>
                                        </a></div>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-5">
                                    <div class="card service-card">
                                        ...
                                        <a class="card-btn" href="tourist-car.php">
                                            <div class="card-footer">
