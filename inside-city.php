...
<php lang="en">
    ...
    <head>
        ...
        <title>Inside City Car Rental-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/insidecity-car-rental-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">Inside City Car Rental Service</h1>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Inside City Car Rental">
                                        <input type="hidden" name="varserviceamount" value="300">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 300 TK</i></butoon>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of Inside City Car Rental Service</h3>
                        </div>
                    </header>
