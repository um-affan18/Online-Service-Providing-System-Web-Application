...
<php lang="en">
    ...
    <head>
        ...
        <title>Wood & Furniture Paint-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/wood-furniture-paint-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">Wood & Furniture Paint</h1>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Wood & Furniture Paint">
                                        <input type="hidden" name="varserviceamount" value="3200">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i> Start From 3200 TK</i></butoon>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of Wood & Furniture Paint Service</h3>
                        </div>
                    </header>
