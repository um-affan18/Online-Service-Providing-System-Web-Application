...
<head>
    ...
    <title>Home Deep Cleaning- TX Service Hand</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="home">
        <header>
            <style>
                .top-banner {
                    background: url(assets/images/servicepic/home-cleaning-banner2.jpg);
            ...
            <div class="container">
                <div class="row banner">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <h1 data-aos="fade-right" data-aos-duration="1500">Home Deep Cleaning</h1>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>On Time Work Completion<i
                                class="fa-solid fa-badge-check"></i></p>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>Trusted and Experienced Cleaner<i
                                class="fa-solid fa-badge-check"></i></p>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>Best Quality Cleaning Accessories<i
                                class="fa-solid fa-badge-check"></i></p>
                                <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Home Deep Cleaning">
                                        <input type="hidden" name="varserviceamount" value="1200">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 1200 TK</i></butoon>
                                </a>
                            </div>
                    </div>
                </div>
            ...
            <div class="row">
                <header class="section-header">
                    <div class="col-12 section-intro">
                        <h3>Overview Of Home Deep Cleaning</h3>
                    </div>
                </header>
                <div class="col-lg-12 pb-xl-3 px-xl-5">
                    <h4 class="pb-2">What' to Expect</h4>
                    <ul>
                        <li>
                            <p>Usage of professional cleaning tools</p>
                        </li>
                        <li>
                            <p>Reasonable price</p>
                        </li>
                        <li>
                            <p>Removal of deep stain</p>
                        </li>
                    </ul>
                </div>

                <div class="col-lg-12 pb-xl-3 px-xl-5">
                    <h4 class="pb-2">What's Exclude</h4>
                    <ul>
                        <li>
                            <p>Repairing</p>
                        </li>
                        <li>
                            <p>Heavy furniture move</p>
                        </li>
                        <li>
                            <p>Permanent spot remove</p>
                        </li>
                    </ul>
                </div>

                <div class="col-lg-12 pb-xl-3 px-xl-5">
                    <h4 class="pb-2">Our Home Cleaning Services</h4>
                    <ul>
                        <li>
                            <p>Bathroom Deep Cleaning (Without Bathtub, Shower
                                Corener)</p>
                        </li>
                        <li>
                            <p>Sofa/Chair Cleaning (If need price will be
                                share accordingly)</p>
                        </li>
                        <li>
                            <p>Kitchen Cleaning (Without Kitchen Hood, inside
                                Cabinet clean, If need price will add accordingly)</p>
                        </li>
                        <li>
                            <p>Carpet Cleaning</p>
                        </li>
                ...
                <div class="col-lg-12 pb-xl-3 px-xl-5">
                    <h4 class="pb-2">Term & Pricing</h4>
                    <ul>
                        <li>
                            <p><strong>Pricing policy:</strong> Price mentioned are based on the minimum quantity stated extra charge will be added if the work scope increases.</p>
                        </li>
                        <li>
                            <p><strong>Payment:</strong> After service completion – respective customers will pay online or COD. After payment please make sure, you have received the SMS containing the money receipt.</p>
                        </li>
