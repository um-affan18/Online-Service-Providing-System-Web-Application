...
<php lang="en">
    ...
    <head>
        ...
        <title>AC Repair-- TX Service Hand</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 section-intro">
                            <h1 class="text-white" data-aos="zoom-in" data-aos-duration="1500">AC Repair Service
                            </h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row mt-3 mx-0">
                    ...
                    <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                        <div class="card service-card">
                            <div class="service-img">
                                <img src="assets/images//servicepic/ac-installation-uninstallation.jpg" class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                        <div class="card service-card">
                            <div class="service-img">
                                <img src="assets/images//servicepic/ac-master.jpg" class="img-fluid">
                            </div>
                            <a class="card-btn" href="ac-master-service.php">
                                <div class="card-footer">
                                    <h3>AC Master Service</h3>
                                    <span>Start From 1100Tk</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                        <div class="card service-card">
                            <div class="service-img">
                                <img src="assets/images//servicepic/ac-water-drop.jpg" class="img-fluid">
                            </div>
                            <a class="card-btn" href="ac-water-drop.php">
                                <div class="card-footer">
                                    <h3>AC Water Drop Solution</h3>
                    ...
                    <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                        <div class="card service-card">
                            <div class="service-img">
                                <img src="assets/images//servicepic/ac-cooling-service.jpg" class="img-fluid">
                            </div>
                            <a class="card-btn" href="ac-cooling-problem.php">
                                <div class="card-footer">
                                    <h3>AC Cooling Problem</h3>
