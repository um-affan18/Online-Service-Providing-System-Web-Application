...
<head>
    ...
    <title>Refrigerator Service-- TX Service Hand</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="home">
        <header>
            <style>
                .top-banner {
                    background: url(assets/images/servicepic/refrigerator-clinning-banner.jpg);
            ...
            <div class="container">
                <div class="row banner">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <h1 data-aos="fade-right" data-aos-duration="1500">Refrigerator Cleaning Service</h1>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>Service Warranty<i
                                class="fa-solid fa-badge-check"></i></p>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>Trusted & Reliable Refrigerator Technicians<i
                                class="fa-solid fa-badge-check"></i></p>
                      
                                <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Refrigerator Cleaning">
            ...
            <div class="row">
                <header class="section-header">
                    <div class="col-12 section-intro">
                        <h3>Overview Of Refrigerator Cleaning Service</h3>
                    </div>
                </header>
