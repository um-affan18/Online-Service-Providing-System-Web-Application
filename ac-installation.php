...
<php lang="en">
    ...
    <head>
        ...
        <title>AC Instalation & Uninstall- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/ac-installation-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-7 col-md-7">
                            <h1 data-aos="fade-right" data-aos-duration="1500">AC Instalation & Uninstall</h1>
                            ...
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Trusted and Experienced AC Technicians<i class="fa-solid fa-badge-check"></i></p>
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Best Quality Sevice Accessories<i class="fa-solid fa-badge-check"></i></p>

                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="AC Installation & Uninstallation">
                                        <input type="hidden" name="varserviceamount" value="2200">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 2200 TK</i></butoon>
                                </a>
                            </div>
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of AC Instalation & Uninstall</h3>
                        </div>
                    </header>
                    <div class="col-lg-12 pb-xl-3 px-xl-5">
                        ...
                        <ul>
                            <li>
                                <p>Usage of professional service tools</p>
                            </li>
                            <li>
