...
<head>
    ...
    <title>Common Space Cleaning-- TX Service Hand</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="home">
        <header>
            <style>
                .top-banner {
                    background: url(assets/images/servicepic/common-space-cleaning-banner.jpg);
            ...
            <div class="container">
                <div class="row banner">
                    ...
                    <div class="col-lg-8 col-md-6">
                        <h1 data-aos="fade-right" data-aos-duration="1500">Common Space Cleaning</h1>
                        ...
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                ...
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Common Space Cleaning">
            ...
            <div class="row">
                <header class="section-header">
                    <div class="col-12 section-intro">
                        <h3>Overview Of Common Space Cleaning</h3>
                    </div>
                </header>
