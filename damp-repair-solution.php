...
<head>
    ...
    <title>Damp Repair-- TX Service Hand</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="home">
        <header>
            <style>
                .top-banner {
                    background: url(assets/images/servicepic/damp-repair-banner.jpg);
            ...
            <div class="container">
                <div class="row banner">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <h1 data-aos="fade-right" data-aos-duration="1500">Damp Repair Solution</h1>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>Background Checked Skilled Painter<i
                                class="fa-solid fa-badge-check"></i></p>
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                class="fa-solid fa-circle-arrow-right px-2"></i>Color Consultation & Transparent Pricing<i
                                class="fa-solid fa-badge-check"></i></p>
                      
                                <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Damp Repair Solution">
                                ...
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="4200"></i>Start From 2200 TK</i></butoon>
                                </a>
                            </div>
                    </div>
                </div>
            ...
            <div class="row">
                <header class="section-header">
                    <div class="col-12 section-intro">
                        <h3>Overview Of Damp Repair Solution</h3>
                    </div>
                </header>
