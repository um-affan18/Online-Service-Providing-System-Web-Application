...
<php lang="en">
    ...
    <head>
        ...
        <title>AC Service- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/ac-service-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-7 col-md-7">
                            <h1 data-aos="fade-right" data-aos-duration="1500">AC Service</h1>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="AC Service">
                                        <input type="hidden" name="varserviceamount" value="1500">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 1500 TK</i></butoon>
                                </a>
                            </div>
                        </div>
                    </div>
