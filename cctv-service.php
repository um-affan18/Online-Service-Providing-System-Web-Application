...
<php lang="en">
    ...
    <head>
        ...
        <title>CCTV Service-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/cctv-camera-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">CCTV Camera Service</h1>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="CCTV Camera Service">
                                        <input type="hidden" name="varserviceamount" value="600">
                                        <input class="main-btn" data-aos="zoom-in" data-aos-duration="1500" type="submit" value="Booking Now">
                                    </form>
                                </a>
                                <a href="#">
                                    <butoon class="main-btn" data-aos="zoom-in" data-aos-duration="1500"></i>Start From 600 TK</i></butoon>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <header class="section-header">
                        <div class="col-12 section-intro">
                            <h3>Overview Of CCTV Camer Service</h3>
                        </div>
                    </header>
                    <div class="col-lg-12 pb-xl-3 px-xl-5">
                        ...
                        <ul>
                            <li>
                                <p>CCTV Camera Repair</p>
                            </li>
                            <li>
                                <p>Software Installation</p>
                            </li>
                            <li>
                                <p>Cables checking from cameras to monitor or recording devices</p>
                            </li>
