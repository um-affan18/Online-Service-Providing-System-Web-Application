...
<head>
    ...
    <title>Painting Service-- TX Service Hand</title>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown dropdown-mega position-static">
                            <a class="nav-link active dropdown-toggle" href="#services" id="navbarDropdown"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 section-intro">
                        <h1 class="text-white" data-aos="zoom-in" data-aos-duration="1500">Painting Service
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-3 mx-0">
                ...
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        <div class="service-img">
                            <img src="assets/images//servicepic/wood-furniture-paint.jpg" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        <div class="service-img">
                            <img src="assets/images//servicepic/enamel-paint.jpg" class="img-fluid">
                        </div>
                        <a class="card-btn" href="enamel-paint.php">
                            <div class="card-footer">
                                <h3>Enamel Paint</h3>
                                <span>Start From 4200Tk</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        <div class="service-img">
                            <img src="assets/images//servicepic/damp-repair.jpg" class="img-fluid">
                        </div>
                        <a class="card-btn" href="damp-repair-solution.php">
                            <div class="card-footer">
                                <h3>Damp Repair Solution</h3>
                                <span>Start From 5200Tk</span>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="row mx-0">
                ...
                <div class="col-lg-3 col-sm-6 mb-5" data-aos="fade-up" data-aos-duration="1500">
                    <div class="card service-card">
                        ...
                        <a class="card-btn" href="refrigator-repair.php">
                            <div class="card-footer">
