...
<head>
    ...
    <title>Sink Repair-- TX Service Hand</title>
            ...
            <div class="container">
                <div class="row banner">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <h1 data-aos="fade-right" data-aos-duration="1500">Sink Repair Service</h1>
                        ...
                        <p data-aos="fade-left" data-aos-duration="1500"><i
                                ...
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Sink Reparir">
            ...
            <div class="row">
                <header class="section-header">
                    <div class="col-12 section-intro">
                        <h3>Overview Of Sink Repair Servicecing</h3>
                    </div>
                </header>
