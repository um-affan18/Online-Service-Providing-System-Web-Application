...
<php lang="en">
    ...
    <head>
        ...
        <title>Car Wash-- TX Service Hand</title>
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <section id="home">
            <header>
                <style>
                    .top-banner {
                        background: url(assets/images/servicepic/car-wash-banner.jpg);
                ...
                <div class="container">
                    <div class="row banner">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <h1 data-aos="fade-right" data-aos-duration="1500">Car Wash</h1>
                            ...
                            <p data-aos="fade-left" data-aos-duration="1500"><i class="fa-solid fa-circle-arrow-right px-2"></i>Best Cleaning Tools.<i class="fa-solid fa-badge-check"></i></p>

                            <div class="mt-4 d-flex justify-content-between">
                                <a href="#">
                                    <form method="GET" action="service-booking.php">
                                        <input type="hidden" name="varservice" value="Car Wash">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 pb-xl-3 px-xl-5">
                        ...
                        <ul>
                            <li>
                                <p>Professional Cleaning Toola</p>
                            </li>
                            <li>
                                <p>Best Service at an Affordable Price</p>
                            </li>
